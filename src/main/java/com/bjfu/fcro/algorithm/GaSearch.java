...
import com.bjfu.fcro.algorithm.Two_Opt;
...
public class GaSearch {
	 ...
	 * @return
	 */
	public static com.bjfu.fcro.algorithm.Chromosome gaSearch(double[][] dists, int[] Path){
		int n = dists.length;
		com.bjfu.fcro.algorithm.Chromosome[] pool = new com.bjfu.fcro.algorithm.Chromosome[PoolSize];
		com.bjfu.fcro.algorithm.Chromosome[] sea = new com.bjfu.fcro.algorithm.Chromosome[SeaSize];
